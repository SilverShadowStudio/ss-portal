// MIRROR — keep in sync with src/lib/agreements/index.ts.
// Edge functions cannot import from src/. Copy files across on every change.
...
import type { AgreementDocument, GetAgreementInput } from "./types.ts";
import { buildProjectV3Document, PROJECT_V3_VERSION } from "./project-v3.ts";
import { buildPartnershipV3Document, PARTNERSHIP_V3_VERSION } from "./partnership-v3.ts";
