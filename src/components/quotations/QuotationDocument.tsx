        ...
        >
          ...
          <div style={{ marginTop: 28 }}>
            <Section>
              <Field heading="Quotation">
                <span style={{ fontVariantNumeric: "tabular-nums", fontVariantLigatures: "none" }}>
                  {number}
                </span>
              </Field>
              <Field heading="Date">{fmtDate(data.issued_at || data.created_at)}</Field>
            </Section>
          </div>
          ...
          <div style={{ marginTop: 24 }}>
            ...
            >
              ...
              <div style={{ ...label, textAlign: "right" }}>Qty</div>
              <div style={{ ...label, textAlign: "right" }}>Unit</div>
              <div style={{ ...label, textAlign: "right" }}>Total</div>
            </div>
            {items.map((it, i) => {
          ...
          <div style={{ marginTop: 28 }}>
            ...
            <ol style={{ ...body, marginTop: 8, paddingLeft: 22 }}>
              <li>
                <strong style={{ fontWeight: 400 }}>Architectural Plans</strong> — DWG floor plans, elevations, and ceiling plans.
              </li>
              <li>
                <strong style={{ fontWeight: 400 }}>Design and Finishes</strong> — Detailed finishes schedule (walls, windows, fabrics, etc.), FF&amp;E layout plan, lighting and atmosphere mood board.
              </li>
              <li>
                <strong style={{ fontWeight: 400 }}>Reference Material</strong> — Site photography, existing 3D models.
              </li>
            </ol>
          </div>
          ...
          <div style={{ marginTop: 24 }}>
            ...
            <ul style={{ ...body, marginTop: 4, paddingLeft: 22 }}>
          ...
          {data.notes ? (
            <div style={{ marginTop: 20 }}>
              ...
              <div style={{ ...body, marginTop: 10, whiteSpace: "pre-wrap" }}>{data.notes}</div>
            </div>
          ) : null}
