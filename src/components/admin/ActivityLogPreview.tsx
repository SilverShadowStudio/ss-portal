        ...
        <ul className="flex flex-col gap-2 max-h-[28rem] overflow-y-auto">
          {visible.map((row) => (
            <li key={row.id}>
              ...
              >
                <span className="mt-1 inline-flex h-5 min-w-[60px] items-center justify-center rounded bg-gold/20 px-2 text-[8px] font-bold tracking-[0.18em] uppercase text-[#ecd39c]">
